...
<html><head>
	<meta charset="utf-8">
	<title>SisEval - Generación Token</title>
	<meta name="viewport" content="width=device-width, initial-scale=1">
	<link rel="icon" type="image/png" href="../../icons/status/mail-tagged.png" />
	<?php skeleton();?>
...
<div class="panel panel-info" >
  <div class="panel-heading">
    <h2 class="panel-title text-center text-default "><span class="pull-center "><img src="../../icons/status/mail-tagged.png"  class="img-reponsive img-rounded"> TOKEN</h2>
  </div>
    ...
    if($conn){
        ...
        $token = genToken();
        addToken($usuario,$token,$conn);
        gentxt($usuario,$token);
        }
	 }else{
	    mysqli_error($conn);
	  }
